...
;; Version: 2.91
;; Keywords: extensions
;; $Id: crypt++.el,v 1.30 2001/11/15 19:02:44 karl Exp $
...
;;; 2001-11-15|2.91|~/misc/crypt++.el.Z|
...
(defvar crypt-user-defined-encryption-alist nil
  "*User defined encryption list.  Same syntax as `crypt-encryption-alist.'")
...
(defun crypt-build-encryption-alist ()
  ...
  (append
   ;; user defined encrytions
   crypt-user-defined-encryption-alist
   (list
    ;; crypt
    (list 'crypt
